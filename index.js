(() => {
  ...
  var px = function(i2) {
    return new BasicSize(append3(value2(i2))(fromString3("px")));
  };
  var pct = function(i2) {
  ...
  function unsafeReadPropImpl(f, s, key3, value14) {
    return value14 == null ? f : s(value14[key3]);
  }
  ...
  var addForeignPropHandler = function(key3) {
    return function(prop3) {
      return function(reader) {
        return function(f) {
          ...
          return handler$prime(key3)(composeKleisli2(currentTarget)(function(e) {
  ...
  var OpenCurtainToTheRight = /* @__PURE__ */ function() {
    function OpenCurtainToTheRight2(value0) {
      this.value0 = value0;
    }
    ;
    OpenCurtainToTheRight2.create = function(value0) {
      return new OpenCurtainToTheRight2(value0);
    };
    return OpenCurtainToTheRight2;
  }();
  var CloseCurtainToTheLeft = /* @__PURE__ */ function() {
    function CloseCurtainToTheLeft2() {
    }
    ;
    CloseCurtainToTheLeft2.value = new CloseCurtainToTheLeft2();
    return CloseCurtainToTheLeft2;
  }();
  var halogenLink = /* @__PURE__ */ div_([/* @__PURE__ */ h3([/* @__PURE__ */ style2(/* @__PURE__ */ discard2(/* @__PURE__ */ color(/* @__PURE__ */ rgba(245)(255)(250)(1)))(function() {
  ...
  var handleAction = function(v) {
    ...
    if (v instanceof Decrement) {
      return modify_3(function(st) {
        ...
        ;
        $21.count = st.count - 1 | 0;
        return $21;
      });
    }
    ;
    if (v instanceof OpenCurtainToTheRight) {
      return modify_3(function(st) {
        var $24 = {};
        for (var $25 in st) {
        ...
        ;
        $24.count = st.count + 1 | 0;
        $24.moveCurtain = getLength(v.value0);
        return $24;
      });
    }
    ;
    if (v instanceof CloseCurtainToTheLeft) {
      return modify_3(function(st) {
        var $28 = {};
        for (var $29 in st) {
        ...
        $28.moveCurtain = false;
        return $28;
      });
    }
    ;
    throw new Error("Failed pattern match at App.Simple (line 147, column 16 - line 151, column 93): " + [v.constructor.name]);
  };
  var getCurtainClassList = function(moveCurtain) {
    return append7(["curtain"])(function() {
      if (moveCurtain) {
        return ["curtain-move-right"];
      }
      ;
      return [];
    }());
  ...
  var render2 = function(_state) {
    return div2([id2("content-container")])([halogenLink, div2([style2(marginLeft(pct(90)))])([img([src("../assets/ellipse_ek4.png"), alt2("language")])]), div2([css("center-container")])([div2([css("my-simple-input")])([input([type_4(InputText.value), onValueInput(function(str) {
      return new OpenCurtainToTheRight(str);
    }), placeholder("tezku le mitzvot!")]), img([css("input-icon"), src("../assets/lupe.png"), alt2("lupe")])])]), div2([classes(getCurtainClassList(_state.moveCurtain)), style2(discard2(paddingTop(pct(7)))(function() {
      return discard2(paddingRight(px(40)))(function() {
        return paddingLeft(px(70));
      });
    }))])([text(" This ENumber Dictionary is based on Sefer Mahor LeKaschrut and on Sefer of Rabbi Pantelyat; it is not exhaustive and is meant to be used as a reference only. For more information, please consult a competent Halachic authority.")]), div2([id2("footer_variant2")])([div2([])([img([src("../assets/union.png"), alt2("copyright")])]), text(" "), text("\xA9 2024. We love Israel")])]);
  };
  ...
  var lookup1 = /* @__PURE__ */ lookup3(ordForkId);
