module Data.ENumberTypes (ENumber, ENumberList, AdditiveGroup(..), Source(..), Kashrut(..), colorENumberList, emptyENumberList, insertEntry) where 

-- THIS MODULE DOES NOT DEPEND ON HEAD

-- import Data.Head(AdditiveGroup, Kashrut, Source, showK, showSources)
-- (findENumbersInList, AdditiveGroup, Source(
...
data AdditiveGroup =  Colour | Preservative | Antioxidant | FlavourEnchancer | Sweetener | Emulsifier | Stabilizer
